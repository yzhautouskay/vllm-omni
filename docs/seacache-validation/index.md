# SeaCache validation report

SeaCache was evaluated against the no-cache path using matched seeds, cookbook prompts/assets, and regional diffusion compilation. Quality assessed with full PaiBench-I2V suite, visual review and fidelity metrics.
